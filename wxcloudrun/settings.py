...
MERCHANT_NOTIFY_SEND_RETRY_COUNT = parse_env_int('MERCHANT_NOTIFY_SEND_RETRY_COUNT', '2')
MERCHANT_NOTIFY_SEND_RETRY_DELAY_SECONDS = parse_env_float('MERCHANT_NOTIFY_SEND_RETRY_DELAY_SECONDS', '1.5')
...
MERCHANT_NOTICE_DISPATCH_CONCURRENCY = parse_env_int('MERCHANT_NOTICE_DISPATCH_CONCURRENCY', '20')
MERCHANT_NOTICE_DISPATCH_WORKER_HEARTBEAT_SECONDS = parse_env_float('MERCHANT_NOTICE_DISPATCH_WORKER_HEARTBEAT_SECONDS', '15')
MERCHANT_NOTICE_DISPATCH_PROGRESS_BATCH_SIZE = parse_env_int('MERCHANT_NOTICE_DISPATCH_PROGRESS_BATCH_SIZE', '50')
MERCHANT_NOTICE_WECHAT_443_RETRY_DELAY_SECONDS = parse_env_float('MERCHANT_NOTICE_WECHAT_443_RETRY_DELAY_SECONDS', '3')
MERCHANT_NOTICE_WECHAT_443_REFRESH_THRESHOLD = parse_env_int('MERCHANT_NOTICE_WECHAT_443_REFRESH_THRESHOLD', '3')
